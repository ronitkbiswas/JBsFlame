  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="px-4 pb-4">
        ...
        <div className="mt-2 mb-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="px-3 py-2">
            <div className="flex justify-between items-start mb-1.5">
              <div className="flex items-center gap-1">
                ...
                <div className="p-0.5 hover:bg-gray-100 rounded-full cursor-pointer transition-colors">
                  <Info className="w-3.5 h-3.5 text-gray-900 stroke-[2.5]" />
                </div>
              </div>
              <div className="flex flex-col items-center">
                <div className="flex items-center gap-1 bg-[#1A8D49] text-white px-2 py-0.5 rounded-lg font-black text-[12px]">
                  <Star className="w-3.5 h-3.5 fill-white text-white" />
                  <span>4.4</span>
                </div>
                <span className="text-[10px] font-bold text-gray-400 border-b border-gray-300 border-dotted pb-0 mt-0.5 whitespace-nowrap">By 2.9k+</span>
              </div>
            </div>
            ...
            <div className="flex gap-1.5 overflow-x-auto no-scrollbar -mx-4 px-4 pb-0.5">
               <div className="flex-shrink-0 inline-flex bg-[#F3F7FB] px-2.5 py-1 rounded-xl items-center gap-1">
                  <Check className="w-3 h-3 text-emerald-600 stroke-[3]" />
                  <span className="text-[12px] font-bold text-gray-700 whitespace-nowrap">No packaging charges</span>
               </div>
               <div className="flex-shrink-0 inline-flex bg-[#F3F7FB] px-2.5 py-1 rounded-xl items-center gap-1">
                  <Check className="w-3 h-3 text-emerald-600 stroke-[3]" />
                  <span className="text-[12px] font-bold text-gray-700 whitespace-nowrap">Last 100 orders without complain</span>
               </div>
               <div className="flex-shrink-0 inline-flex bg-[#F3F7FB] px-2.5 py-1 rounded-xl items-center gap-1">
                  <Check className="w-3 h-3 text-emerald-600 stroke-[3]" />
                  <span className="text-[12px] font-bold text-gray-700 whitespace-nowrap">Frequently reordered</span>
               </div>
            </div>
          </div>
          ...
          <div className="px-3 py-1.5 flex items-center justify-between">
             <div className="flex items-center gap-1.5">
                ...
                <p className="text-[13px] font-bold text-gray-500">Free delivery above ₹99</p>
             </div>
             <button className="flex items-center gap-0.5 text-gray-400 font-bold hover:text-gray-600 transition-colors">
               <span className="text-[12px]">4 offers</span>
               <ChevronDown className="w-3.5 h-3.5 text-gray-400" />
             </button>
          </div>
        </div>
